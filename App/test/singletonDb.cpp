...
void threadFoo()
{
    ...
    json jsonData = {
        {"Id", "0630C001AA"}, {"Time", "-----"}, {"Barcode", "0630C001AA"},
        {"PalletInfo", "-----"}, {"Model", "-----"}, {"Merchandise", "0630C001AA"},
        {"NameModel", "F36"}, {"Destination", "-----"}, {"Count", "16"},
        {"ZoneId", "1"}, {"ColumnId", "1"}, {"LocationId", "1"},
        {"queue", 12}
    };
    ...
    client->editInCollection("admin", "pallet_queue", filter.view(), update.view());
...
void threadBar()
{
    ...
    json jsonData = {
        {"Id", "-----"}, {"Time", "-----"}, {"Barcode", "-----"},
        {"PalletInfo", "-----"}, {"Model", "-----"}, {"Merchandise", "0630C001AA"},
        {"NameModel", "-----"}, {"Destination", "-----"}, {"Count", "16"},
        {"ZoneId", "-----"}, {"ColumnId", "-----"}, {"LocationId", "-----"},
        {"queue", 5}
    };
